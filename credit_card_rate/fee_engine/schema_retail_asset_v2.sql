...
DO $$ BEGIN
  CREATE TYPE charge_context_enum AS ENUM (
    'GENERAL','ON_LIMIT','ON_ENHANCED_AMOUNT','ON_REDUCED_AMOUNT','ON_CATEGORY_A','ON_CATEGORY_B','ON_CATEGORY_A_B','ON_CATEGORY_C'
  );
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Add new enum values if the type already exists
DO $$ BEGIN
  ALTER TYPE charge_context_enum ADD VALUE IF NOT EXISTS 'ON_CATEGORY_A';
  ALTER TYPE charge_context_enum ADD VALUE IF NOT EXISTS 'ON_CATEGORY_B';
